...
using std::cout;
/*
You will combine a while loop with an if statement to print every other number. 
...
In C++, the remainder operator is %. In other words, for a given int i, 
you have remainder = i % 2. If remainder equals 0, the number is even.
*/
